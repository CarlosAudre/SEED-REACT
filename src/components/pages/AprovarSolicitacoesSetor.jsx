...
function AprovarSolicitacoesSetor() {
  ...
  const buscarSolicitacoes = async () => {
    try {
      const response = await axios.get('https://ssge.onrender.com/adm/solicitacoes-setor/pendentes', makeConfig());
  ...
  const handleAprovar = async (id) => {
    try {
      await axios.put(`https://ssge.onrender.com/adm/solicitacoes-setor/${id}/aprovar`, null, makeConfig());
  ...
  const handleReprovar = async (id) => {
    if (window.confirm('Tem certeza que deseja REPROVAR esta solicitação?')) {
      try {
        await axios.put(`https://ssge.onrender.com/adm/solicitacoes-setor/${id}/reprovar`, null, makeConfig());
