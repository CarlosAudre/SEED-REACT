...
export function UserSolicitacaoComboItem() {
    ...
    const carregarSolicitacoes = async () => {
        try {
            const resp = await axios.get(
                "https://sua-api-no-render.onrender.com/solicitacoes/responsavel-setor/me",
                makeConfig()
            );
    ...
    const carregarSetoresUsuario = async () => {
        try {
            const resp = await axios.get(
                "https://sua-api-no-render.onrender.com/solicitacoes/responsavel-setor/setores",
                makeConfig()
            );
    ...
    const criar = async (e) => {
        ...
        try {
            await axios.post(
                "https://sua-api-no-render.onrender.com/solicitacoes/responsavel-setor/criar",
                dto,
                makeConfig()
            );
