...
function GerenciarUsuarios() {
  ...
  const buscarUsuarios = async () => {
    try {
      const response = await axios.get('https://ssge.onrender.com/adm/usuarios', makeConfig());
  ...
  const buscarDadosDoModal = async () => {
    try {
      const [resPerfis, resEstruturas] = await Promise.all([
        axios.get('https://ssge.onrender.com/adm/perfis', makeConfig()),
        axios.get('https://ssge.onrender.com/adm/estruturas', makeConfig())
      ]);
  ...
  useEffect(() => {
    if (isResponsavel && estruturaIdSelecionada) {
      const buscarSetores = async () => {
        try {
          const res = await axios.get(`https://ssge.onrender.com/adm/setores/estrutura/${estruturaIdSelecionada}`, makeConfig());
  ...
  const onSubmit = async (data) => {
    ...
    try {
      await axios.put(`https://ssge.onrender.com/adm/usuarios/${usuarioEmEdicao.id}`, payload, makeConfig());
