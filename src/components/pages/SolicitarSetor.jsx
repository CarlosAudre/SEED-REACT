...
function SolicitarSetor() {
  ...
  useEffect(() => {
    const buscarEstruturas = async () => {
      try {
        ...
        const res = await axios.get('https://sua-api-no-render.onrender.com/api/estruturas?todas=true', makeConfig());
  ...
  useEffect(() => {
    ...
    const buscarSetores = async () => {
      try {
        const res = await axios.get(`https://sua-api-no-render.onrender.com/api/setores/estrutura/${estruturaIdSelecionada}`, makeConfig());
        setSetores(res.data);
      } catch (error) {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      await axios.post('https://sua-api-no-render.onrender.com/api/solicitacoes-setor', payload, makeConfig());
