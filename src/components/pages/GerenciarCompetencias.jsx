...
export default function GerenciarCompetencias() {
    ...
    const buscarCompetencias = async () => {
        try {
            const r = await axios.get("https://ssge.onrender.com/adm/competencias", config);
    ...
    const salvar = async (dados) => {
        try {
            ...
            if (edicao) {
                await axios.put(
                    `https://ssge.onrender.com/adm/competencias/${edicao.id}`,
                    payload,
                    config
                );
                ...
                await axios.post(
                    "https://ssge.onrender.com/adm/competencias",
                    payload,
                    config
                );
    ...
    const deletar = async (id) => {
        ...
        try {
            await axios.delete(`https://ssge.onrender.com/adm/competencias/${id}`, config);
