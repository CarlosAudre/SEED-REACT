...
function FolhaPagamentoRh() {
  ...
  useEffect(() => {
    async function carregarItens() {
      try {
        const res = await axios.get('https://ssge.onrender.com/api/rh/itens-disponiveis', makeConfig());
  ...
  const carregarEscolasPorItem = async (itemId) => {
    ...
    setLoading(true);
    try {
      const res = await axios.get(`https://ssge.onrender.com/api/rh/itens/${itemId}/escolas`, makeConfig());
  ...
  const salvarLote = async () => {
    ...
    try {
      await axios.post(
        `https://ssge.onrender.com/api/rh/itens/${itemSelecionado}/salvar-lote`, 
        payload, 
        makeConfig()
      );
