...
function GerenciarCombos() {
  ...
  const buscarCombos = async () => {
    try {
      const response = await axios.get('https://sua-api-no-render.onrender.com/adm/combos', makeConfig());
  ...
  const buscarCompetencias = async () => {
    try {
      const response = await axios.get('https://sua-api-no-render.onrender.com/adm/competencias', makeConfig());
  ...
  const buscarEstruturas = async () => {
    try {
      const response = await axios.get('https://sua-api-no-render.onrender.com/adm/estruturas', makeConfig());
  ...
  const buscarSetores = async (estruturaId) => {
    ...
    try {
      const response = await axios.get(`https://sua-api-no-render.onrender.com/adm/setores/estrutura/${estruturaId}`, makeConfig());
  ...
  const onSubmit = async (data) => {
    ...
    try {
      if (comboEmEdicao) {
        await axios.put(`https://sua-api-no-render.onrender.com/adm/combos/${comboEmEdicao.id}`, dadosFormatados, makeConfig());
        toast.success('Kit atualizado com sucesso!');
      } else {
        await axios.post('https://sua-api-no-render.onrender.com/adm/combos', dadosFormatados, makeConfig());
  ...
  const deletarCombo = async (id) => {
    if (window.confirm('Tem certeza que deseja deletar este kit?')) {
      try {
        await axios.delete(`https://sua-api-no-render.onrender.com/adm/combos/${id}`, makeConfig());
  ...
  const onSubmitEnvio = handleSubmitEnvio(async (formData) => {
    ...
    try {
      await axios.post(
        `https://sua-api-no-render.onrender.com/adm/combos/${comboParaEnvio.id}/estrutura/${estruturaId}`,
        {
