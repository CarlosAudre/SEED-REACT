...
function InformarCenso() {
    ...
    const carregarListas = async () => {
      try {
        const [resEstruturas, resCompetencias] = await Promise.all([
          axios.get('https://sua-api-no-render.onrender.com/api/estruturas', makeConfig()),
          axios.get('https://sua-api-no-render.onrender.com/api/competencias', makeConfig())
        ]);
      ...
      if (estruturaId && competenciaId) {
        ...
        try {
          const res = await axios.get(
            `https://sua-api-no-render.onrender.com/api/censo/${estruturaId}/${competenciaId}`, 
            makeConfig()
          );
  ...
  const onSubmit = async (data) => {
    ...
    try {
        await axios.post('https://sua-api-no-render.onrender.com/api/censo', payload, makeConfig());
